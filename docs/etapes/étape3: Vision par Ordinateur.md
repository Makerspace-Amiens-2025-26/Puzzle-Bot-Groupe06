...
Nous avons également détecté la position de chaque angle grâce à la fonction math.atan2, commande qui permet de calculer l'angle formé entre le tag et l'axe horizontal de la caméra (la fonction degrees permettant de convertir cet angle en degrés).
