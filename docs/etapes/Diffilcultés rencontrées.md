...
Nous avons également rencontré un problème lié à l'alimentation du système pneumatique. La carte Arduino utilisée délivrait une tension de 5 V pour les signaux de commande, tandis que la pompe à vide et l'électrovanne nécessitaient une alimentation de 12 V pour fonctionner correctement. En conséquence, l'électrovanne ne pouvait pas être commandée convenablement avec le montage initial. Cette situation nous a conduits à envisager la conception d'une nouvelle carte électronique adaptée aux besoins en puissance des différents composants.
